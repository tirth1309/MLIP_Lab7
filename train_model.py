...
# Set experiment name
email="tirthvip@andrew.cmu.edu" # TODO: Use a customized experiment name
...
trained_model=train_logistic_regression(X_train, y_train, params)

# TODO: use `pipeline.evaluation` to evaluate the model
accuracy=evaluation(training_model, X_test, y_test)
